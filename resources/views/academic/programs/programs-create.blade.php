    ...
    <div class="max-w-xl bg-white border border-gray-200 rounded-md p-6">
        <form action="{{route('academic.programs.store')}}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <x-form.input name="code" label="Code" placeholder="Ex : GI"  />
                <x-form.select
                    name="type_diplome"
            ...
            <x-form.input name="libelle" label="Libellé" placeholder="Ex : Génie Informatique"  />

            <x-form.input name="nombre_semestres" label="Nombre de semestres" type="number" placeholder="6"  />
